...
public class VendaController {
	...
	public ResponseEntity<List<Venda>> findByEndereco (@RequestParam String enderecoEntrega){
		
		try {
			
			List<Venda> lista = this.vendaService.findByEndereco(enderecoEntrega);
			return new ResponseEntity<>(lista, HttpStatus.OK);
	...
	public ResponseEntity<List<Venda>> buscarVendasAcimaValor (@RequestParam int valor){
		...
		try {
			...
			List<Venda> lista = this.vendaService.buscarVendasAcimaValor(valor);
			return new ResponseEntity<>(lista, HttpStatus.OK);
